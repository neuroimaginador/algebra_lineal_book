...
Dado un vector con sus coordenadas en la base canónica, ¿cómo puedo saber sus coordenadas en otra base $\mathcal{B}$? Tenemos dos vías, una que esploramos aquí y otra que veremos en [la sección siguiente](#cambiobase).
